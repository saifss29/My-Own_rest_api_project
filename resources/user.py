...
class UserList(MethodView):
    ...
    def post(self, user_data):
        if UserModel.query.filter(
            ...
            abort(409, message="A user with same username found")
        ...
        current_app.extensions["queue"].enqueue(send_user_registration_email, user.email, user.username)
       

        return {"message": "A user created successfully"}, 201
